    ...
    def compute_losses(self):
        ...
        *_summ -> Summary variables for above loss functions
        ...
        cycle_consistency_loss_b = \
            self._lambda_cyc__b * losses.cycle_consistency_loss(
            ...
            for epoch in range(sess.run(self.global_step), self._max_step):
                ...
                for i in range(0, max_images):
                    ...
                    fake_B_temp1 = self.fake_image_pool(
                        self.num_fake_inputs, fake_B_temp, fake_B_label_temp, self.fake_images_B)
                    ...
                    _, d_B_loss, summary_str = sess.run(
                        ...
                        feed_dict={
                            ...
                            self.fake_pool_B_label: fake_B_temp1['label']
                        }
                    )
                    writer.add_summary(summary_str, epoch * max_images + i)
                    ...
                    fake_A_temp1 = self.fake_image_pool(
                        self.num_fake_inputs, fake_A_temp, fake_A_label_temp, self.fake_images_A)
                    ...
                    _, d_A_loss, summary_str = sess.run(
                        ...
                        feed_dict={
                            ...
                            self.fake_pool_A_label: fake_A_temp1['label']
                        }
                    )
                    writer.add_summary(summary_str, epoch * max_images + i)
...
def main(to_train, log_dir, config_filename, checkpoint_dir):
    ...
    cyclegan_model = CycleGAN(pool_size, lambda_cyc_a, lambda_cyc_b, lambda_sem_a, lambda_sem_b,
