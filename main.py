        ...
        *_summ -> Summary variables for above loss functions
        ...
        semantic_consistency_loss_a = \
            self._lambda_sem_a * losses.semantic_consistency_loss(
                real_labels=self.oh_labels_a, generated_labels=self.fake_oh_labels_a
            )
        semantic_consistency_loss_b = \
            self._lambda_sem_b * losses.semantic_consistency_loss(
                real_labels=self.oh_labels_b, generated_labels=self.fake_oh_labels_b
            )


        g_loss_A = \
            cycle_consistency_loss_a + cycle_consistency_loss_b + lsgan_loss_b + semantic_consistency_loss_b
        g_loss_B = \
            cycle_consistency_loss_b + cycle_consistency_loss_a + lsgan_loss_a + semantic_consistency_loss_a
